...
const Fields = props => {
    return(
        <div>
          ...
          <p style={{fontSize: 13}}>Matricule *<input className="form-control" type="text" name="matricule" style={{backgroundColor: 'rgb(248,248,248)'}} onChange={(e)=>props.handleChange(e)} value={props.state.matricule}/></p>
